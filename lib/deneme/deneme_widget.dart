...
class DenemeWidget extends StatefulWidget {
  const DenemeWidget({super.key});

  @override
  State<DenemeWidget> createState() => _DenemeWidgetState();
}

class _DenemeWidgetState extends State<DenemeWidget> {
  late DenemeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DenemeModel());
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        FFAppState().addToDeneme(_model.textController1.text);
                        setState(() {});
                      },
                      text: 'ekle',
                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        FFAppState().addToDene2(_model.textController2.text);
                        setState(() {});
                      },
                      text: 'ekle',
                      options: FFButtonOptions(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        FFAppState().deneme =
                          ...
                          return var1 = List.from(var1)..addAll(var2);
                        }(FFAppState().deneme.toList(),
                                    FFAppState().dene2.toList())
                                .toList()
                                .cast<String>();
                        setState(() {});
                      },
