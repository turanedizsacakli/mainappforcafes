...
class Table9Record extends FirestoreRecord {
  Table9Record._(
    super.reference,
    super.data,
  ) {
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('table9');

  static Stream<Table9Record> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => Table9Record.fromSnapshot(s));

  static Future<Table9Record> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => Table9Record.fromSnapshot(s));

  static Table9Record fromSnapshot(DocumentSnapshot snapshot) => Table9Record._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static Table9Record getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      Table9Record._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'Table9Record(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is Table9Record &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createTable9RecordData({
  int? tableNumber,
...
class Table9RecordDocumentEquality implements Equality<Table9Record> {
  const Table9RecordDocumentEquality();

  @override
  bool equals(Table9Record? e1, Table9Record? e2) {
  ...
  @override
  int hash(Table9Record? e) => const ListEquality().hash([
        e?.tableNumber,
        e?.costOfThisPost,
        e?.date,
        e?.waiterName,
  ...
  @override
  bool isValidKey(Object? o) => o is Table9Record;
}
