...
class Table7Record extends FirestoreRecord {
  Table7Record._(
    super.reference,
    super.data,
  ) {
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('table7');

  static Stream<Table7Record> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => Table7Record.fromSnapshot(s));

  static Future<Table7Record> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => Table7Record.fromSnapshot(s));

  static Table7Record fromSnapshot(DocumentSnapshot snapshot) => Table7Record._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static Table7Record getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      Table7Record._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'Table7Record(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is Table7Record &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createTable7RecordData({
  int? tableNumber,
...
class Table7RecordDocumentEquality implements Equality<Table7Record> {
  const Table7RecordDocumentEquality();

  @override
  bool equals(Table7Record? e1, Table7Record? e2) {
  ...
  @override
  int hash(Table7Record? e) => const ListEquality().hash([
        e?.tableNumber,
        e?.costOfThisPost,
        e?.date,
        e?.waiterName,
  ...
  @override
  bool isValidKey(Object? o) => o is Table7Record;
}
