...
class Table12Record extends FirestoreRecord {
  Table12Record._(
    super.reference,
    super.data,
  ) {
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('table12');

  static Stream<Table12Record> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => Table12Record.fromSnapshot(s));

  static Future<Table12Record> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => Table12Record.fromSnapshot(s));

  static Table12Record fromSnapshot(DocumentSnapshot snapshot) =>
      Table12Record._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static Table12Record getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      Table12Record._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'Table12Record(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is Table12Record &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createTable12RecordData({
  int? tableNumber,
...
class Table12RecordDocumentEquality implements Equality<Table12Record> {
  const Table12RecordDocumentEquality();

  @override
  bool equals(Table12Record? e1, Table12Record? e2) {
  ...
  @override
  int hash(Table12Record? e) => const ListEquality().hash([
        e?.tableNumber,
        e?.costOfThisPost,
        e?.date,
        e?.waiterName,
  ...
  @override
  bool isValidKey(Object? o) => o is Table12Record;
}
