...
class Table6Record extends FirestoreRecord {
  Table6Record._(
    super.reference,
    super.data,
  ) {
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('table6');

  static Stream<Table6Record> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => Table6Record.fromSnapshot(s));

  static Future<Table6Record> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => Table6Record.fromSnapshot(s));

  static Table6Record fromSnapshot(DocumentSnapshot snapshot) => Table6Record._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static Table6Record getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      Table6Record._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'Table6Record(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is Table6Record &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createTable6RecordData({
  int? tableNumber,
...
class Table6RecordDocumentEquality implements Equality<Table6Record> {
  const Table6RecordDocumentEquality();

  @override
  bool equals(Table6Record? e1, Table6Record? e2) {
  ...
  @override
  int hash(Table6Record? e) => const ListEquality().hash([
        e?.tableNumber,
        e?.costOfThisPost,
        e?.date,
        e?.waiterName,
  ...
  @override
  bool isValidKey(Object? o) => o is Table6Record;
}
