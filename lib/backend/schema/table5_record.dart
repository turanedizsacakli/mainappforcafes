...
class Table5Record extends FirestoreRecord {
  Table5Record._(
    super.reference,
    super.data,
  ) {
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('table5');

  static Stream<Table5Record> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => Table5Record.fromSnapshot(s));

  static Future<Table5Record> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => Table5Record.fromSnapshot(s));

  static Table5Record fromSnapshot(DocumentSnapshot snapshot) => Table5Record._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static Table5Record getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      Table5Record._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'Table5Record(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is Table5Record &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createTable5RecordData({
  int? tableNumber,
...
class Table5RecordDocumentEquality implements Equality<Table5Record> {
  const Table5RecordDocumentEquality();

  @override
  bool equals(Table5Record? e1, Table5Record? e2) {
  ...
  @override
  int hash(Table5Record? e) => const ListEquality().hash([
        e?.tableNumber,
        e?.costOfThisPost,
        e?.date,
        e?.waiterName,
  ...
  @override
  bool isValidKey(Object? o) => o is Table5Record;
}
